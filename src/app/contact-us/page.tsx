            ...
            >
              <div className="bg-white/70 backdrop-blur-xl border border-white/20 rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden text-left">
                ...
                <div className="text-left mb-10">
                  <h1 className="text-4xl md:text-5xl font-black uppercase italic tracking-tighter mb-3 bg-gradient-to-r from-sky-500 to-green-500 bg-clip-text text-transparent leading-none text-left">
                    Write to Bergman
                  </h1>
                  <p className="text-slate-600 font-medium md:text-lg leading-relaxed max-w-xl text-left">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                      <FormField control={form.control} name="name" render={({ field }) => (
                        <FormItem className="text-left">
                          <FormLabel className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1 text-left">Full Name*</FormLabel>
                          <FormControl>
                            <Input 
                              required 
                              ...
                              className="rounded-2xl h-14 border-slate-200 bg-white shadow-sm focus:border-sky-500 focus:ring-sky-500/15 transition-all text-sm font-bold text-left" 
                            />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      ...
                      <FormField control={form.control} name="email" render={({ field }) => (
                        <FormItem className="text-left">
                          <FormLabel className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1 text-left">Email Address*</FormLabel>
                          <FormControl>
                            <Input 
                              type="email" 
                              required 
                              ...
                              {...field} 
                              disabled={isSubmitting} 
                              className="rounded-2xl h-14 border-slate-200 bg-white shadow-sm focus:border-sky-500 focus:ring-sky-500/15 transition-all text-sm font-bold lowercase text-left" 
                            />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      ...
                      <FormField control={form.control} name="mobile" render={({ field }) => (
                        <FormItem className="text-left md:col-span-2">
                          <FormLabel className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1 text-left">Mobile Number (WhatsApp)*</FormLabel>
                          <FormControl>
                            <Input 
                              type="tel" 
                              required 
                      ...
                      <FormField control={form.control} name="message" render={({ field }) => (
                        <FormItem className="md:col-span-2 text-left">
                          <FormLabel className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1 text-left">Detailed Message*</FormLabel>
                          <FormControl>
                            <Textarea 
                              required 
                              ...
                              disabled={isSubmitting} 
                              rows={6} 
                              className="rounded-[2rem] border-slate-200 bg-white shadow-sm focus:border-sky-500 focus:ring-sky-500/15 transition-all text-sm font-medium leading-relaxed resize-none p-6 text-left" 
                            />
                          </FormControl>
                          <FormMessage />
                        </FormItem>

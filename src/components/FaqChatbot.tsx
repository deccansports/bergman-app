...
export default function FaqChatbot() {
  ...
  const handleSendMessage = useCallback(async (messageText: string) => {
    ...
    try {
        const context = allFaqs.map(f => ({ question: f.question, answer: f.answer }));
        ...
        setMessages(prev => [...prev, { id: Date.now() + 1, text: "I'm experiencing a high-performance sync issue. Please try again or contact support at **info@bergmantri.com**.", from: 'bot' }]);
    } finally {
        setIsLoading(false);
    }

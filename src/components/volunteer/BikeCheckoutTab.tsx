...
import { Loader2, Search as SearchIcon, Send, Bike, RefreshCw, User, Smartphone, AlertTriangle } from 'lucide-react';
import type { EventParticipant } from '@/lib/types';
import { searchParticipantForBikeAction, manualBikeCheckOutAction, resetBikeCheckOutAction, sendBikeCheckoutReminderAction } from '@/lib/actions/volunteerActions';
    ...
    <Card className="bg-background shadow-md">
      ...
      <CardContent className="space-y-4">
        <form onSubmit={handleBikeCheckoutSearch} className="flex flex-col sm:flex-row gap-2">
          <Select value={bikeCheckoutSearchBy} onValueChange={(v) => setBikeCheckoutSearchBy(v as any)}>

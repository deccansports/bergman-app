...
import type { LiveAthlete, EventCalendarEntry, TicketDefinition, Status, Leg } from '@/lib/types';
import { useToast } from '@/hooks/use-toast';
import { getLiveTimingDataAction } from '@/lib/actions';
import { hmsToSeconds, formatSecondsToHMS, isDuathlonEvent, normalizeStatus } from '@/lib/utils';
import { Card, CardHeader, CardTitle, CardDescription, CardContent } from '@/components/ui/card';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { Loader2, Clock, Flag, Search as SearchIcon, Users, PlayCircle, CheckCircle, XCircle, AlertTriangle, RefreshCw } from 'lucide-react';
